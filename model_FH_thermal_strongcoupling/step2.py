...
random_gaussia_real = np.random.normal(0,0.01,num_T)
random_gaussia_imag = np.random.normal(0,0.01,num_T)
random_noise = random_gaussia_real + 1j*random_gaussia_imag
